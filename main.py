...
df = pd.read_csv('Liquid_Level_Lab2_Group_12.csv')
print(df.head())
...
fig = go.Figure()
fig.add_trace(go.Scatter(x=time, y=tank1,
                    mode='markers', name='markers'))
fig.add_trace(go.Scatter(x=time, y=tank2,
                    mode='markers', name='markers'))
fig.add_trace(go.Scatter(x=time, y=tank3,
                    mode='markers', name='markers'))
fig.add_trace(go.Scatter(x=time, y=flow,
                    mode='markers', name='markers'))
